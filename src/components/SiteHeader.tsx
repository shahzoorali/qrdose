...
const TICKER_TEXT =
  "QRdose notifies up to 10 contacts all at once, with a single tap or scan. No app, no fuss.";
...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-30">
      ...
      {/* Floating nav */}
      <div className="bg-gradient-to-b from-slate-50/95 to-transparent px-4 pb-3 pt-3 backdrop-blur sm:px-6">
        <nav className="relative mx-auto flex max-w-6xl items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-lg">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <Link
              href="/signup"
              className="ml-1 hidden rounded-lg bg-brand-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-700 sm:block"
            >
              Create account
            </Link>
          </div>
